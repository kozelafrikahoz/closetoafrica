...
var locIhopeIhaventUsedThisBefore = window.location.href+'';
if (locIhopeIhaventUsedThisBefore.indexOf('http://')==0){
    window.location.href = locIhopeIhaventUsedThisBefore.replace('http://','https://');
}
